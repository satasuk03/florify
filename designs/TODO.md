...
- [ ] **Harvest particles / confetti** (designs/07 §7.11) — currently `HarvestOverlay` shows a rarity-tinted glow + text. Designs called for particle confetti on legendary harvests. Low priority — the existing overlay already feels celebratory.
