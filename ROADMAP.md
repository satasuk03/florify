...
> **หมายเหตุ:** ได้แต้มเฉพาะกรณีที่ยังสะสมไม่ครบทุกสายพันธุ์ ถ้าครบทุกสายพันธุ์แล้ว จะไม่สะสมแต้ม

**รีเซ็ต counter:**

- สะสมครบ **100 points** → จะได้รับสายพันธุ์ที่ยังไม่เคยปลดล็อก 1 ตัว (สุ่มจากที่ยังไม่มี) แล้วรีเซ็ตเป็น 0 เช่นกัน (เริ่มนับใหม่)
- ได้ต้นใหม่ (ไม่ซ้ำ) จากการปลูกปกติระหว่างทาง → รีเซ็ตเป็น 0 เช่นกัน (เริ่มนับใหม่)

**กรณีครบ 100 points — สุ่ม rarity ของต้นที่ได้:**

ระบบจะสุ่มตาม rarity weight ปกติ แต่ถ้า rarity ที่สุ่มได้ครบหมดแล้ว (เช่น สุ่มได้ common แต่ common ครบ 200/200 แล้ว) จะถือว่าได้ต้นซ้ำไปตามปกติ แล้วสะสมแต้ม pity ต่อ — ต้องรอจนสุ่มได้ rarity ที่ยังเหลือต้นไม่ครบ ถึงจะได้ต้นใหม่จริง ๆ
