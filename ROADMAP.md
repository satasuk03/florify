...
เลือก "ต้นไม้ที่อยากได้" 1 ชนิด (จากที่ยังไม่มี) ทุกครั้งที่ปลูกแล้วไม่ได้ตัวนั้นจะสะสม pity counter — ยิ่งปลูกเยอะ โอกาสได้ตัวที่ wish ไว้ยิ่งสูงขึ้น ป้องกันปัญหา endgame ที่เหลือไม่กี่ตัวแต่สุ่มไม่เจอ
