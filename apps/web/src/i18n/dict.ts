...
export const dict = {
  th: {
    ...
    "guide.sprout.body": "🌱 คือสกุลเงินในเกมที่ใช้ซื้อ Booster Pack และเปลี่ยนภารกิจ ได้จากการเก็บเกี่ยวต้นไม้และทำภารกิจประจำวันครบ",
    ...
    "guide.sprout.refreshBody": "ใช้ {cost} 🌱 เพื่อสุ่มภารกิจใหม่แทนที่ภารกิจที่ยังไม่เสร็จ",
    "guide.shop.title": "ร้านค้า Sprout Shop",
    "guide.shop.body": "ใช้ 🌱 ซื้อ Booster Pack เพื่อสุ่มรับสายพันธุ์ต้นไม้ มี 3 ระดับให้เลือก แต่ละระดับมีโอกาสได้ต้นไม้หายากต่างกัน",
    "guide.shop.duplicate": "ถ้าได้สายพันธุ์ซ้ำจะได้ใบไม้แห้ง 🍂 เหมือนกับการเก็บเกี่ยวปกติ",
  ...
  en: {
    ...
    "guide.sprout.body": "🌱 is the in-game currency used to buy Booster Packs and refresh quests. Earn it by harvesting trees and completing all daily missions.",
    ...
    "guide.sprout.refreshBody": "Spend {cost} 🌱 to replace an incomplete mission with a new random one.",
    "guide.shop.title": "Sprout Shop",
    "guide.shop.body": "Spend 🌱 on Booster Packs to receive a random species. Three tiers available, each with different rarity odds.",
    "guide.shop.duplicate": "Duplicate species from boosters give dried leaves 🍂, just like normal harvesting.",
