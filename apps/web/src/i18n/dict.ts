...
export const dict = {
  th: {
    ...
    'guide.howto.water.body': 'แตะรดน้ำแต่ละครั้งใช้ 1 หยด สะสมได้สูงสุด 50 หยด (ฟื้นฟู 1 หยดทุก 2 นาที) แต่ละต้นใช้ 12–20 หยด',
    ...
    'guide.driedLeaves.body': 'เก็บเกี่ยวต้นไม้ที่มีแล้วจะได้ใบไม้แห้ง สะสมครบ {threshold} ใบจะได้สายพันธุ์ใหม่ที่ยังไม่เคยมี 1 ต้น',
    'guide.driedLeaves.rates': '+{common} ธรรมดา · +{rare} หายาก · +{legendary} ตำนาน',
  ...
  en: {
    ...
    'guide.howto.water.body': 'Each tap costs 1 water drop. You can hold up to 50 drops (1 drop regenerates every 2 minutes). Each tree needs 12–20 drops.',
    ...
    'guide.driedLeaves.body': 'Harvesting a species you already own earns dried leaves. Collect {threshold} to receive a new species you have never had.',
    'guide.driedLeaves.rates': '+{common} common · +{rare} rare · +{legendary} legendary',
    'guide.driedLeaves.progress': '🍂 {current} / {threshold}',
    'harvest.driedLeavesGained': '🍂 +{points}',
