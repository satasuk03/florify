...
export const dict = {
  th: {
    ...
    'guide.howto.water.body': 'แตะรดน้ำแต่ละครั้งใช้ 1 หยด สะสมได้สูงสุด 30 หยด (ฟื้นฟู 1 หยดทุก 2 นาที) แต่ละต้นใช้ 12–20 หยด',
  ...
  en: {
    ...
    'guide.howto.water.body': 'Each tap costs 1 water drop. You can hold up to 30 drops (1 drop regenerates every 2 minutes). Each tree needs 12–20 drops.',
