...
const OVERRIDES: Record<string, [string, string, string]> = {
  ...
  seapansy: [
    'A tiny heart-shaped disc of rose-purple colonial organism, barely a centimetre wide, nestled in white sand, single short peduncle, minute polyp buds just visible, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing heart-shaped sea pansy colony, several centimetres across, vivid rose-purple, rows of white feeding polyps rippling in concentric waves across the surface, anchored in sandy reef floor, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Sea Pansy colony, full heart-shaped disc of deep rose-purple in brilliant shallow reef light, dense feeding polyps creating a visible wave-like blush pattern from centre to edge, white sand below, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  cresttunic: [
    'A tiny cluster of two or three translucent lobed sea-glass-green tunicate tubes on sunlit reef rock, barely visible siphon openings at tops, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing colonial tunicate with several tall translucent lobed towers, sea-glass green fading to pale aquamarine at the tips, attached to warm reef rock, visible pulsing texture, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A dramatic mature Crest Tunic colony, multiple tall translucent lobed towers clustered on sunlit reef rock, vivid sea-glass green to pale aquamarine gradient, shared siphons open at the tips, shimmering light refracting through translucent bodies, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  sunvarnish: [
    'A small patch of warm amber-gold crustose alga on bare reef limestone, glossy surface, tiny concentric growth ring visible, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A spreading patch of Sun Varnish alga, glossy lacquer-like amber-gold surface with a paler cream centre where older tissue has bleached, vivid growing edge, sunlight reflecting off glossy surface, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A large mature Sun Varnish colony covering a broad expanse of reef rock, concentric rings of warm gold to pale cream, outer edge burning amber in brilliant reef light, gloss sheen catching rays from above, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  needletuft: [
    'A tiny cluster of three or four stiff upright bottle-green spine-like fronds, translucent glass-like tips catching sunlight, on sandy reef floor, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Needle Tuft colony, several tight upright clusters of stiff dark green needle fronds, translucent tips sparkling in reef light, perfectly vertical despite surrounding current, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Needle Tuft in full display, dense upright clusters of stiff bottle-green spine fronds, each translucent tip catching a point of sunlight like glass needles, the colony absolutely still while seaweed sways around it, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  coppercup: [
    'A tiny solitary cup coral no wider than a coin, reddish-brown copper-colored skeleton, barely-visible polyp bud at centre, attached to reef rock, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Copper Cup coral, wide shallow cup of hammered-copper reddish-brown skeleton, central polyp extending soft burnt-orange tentacles tipped with deeper amber, sunlit shallow reef, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Copper Cup in full bloom, dramatic wide shallow cup of rich warm reddish-brown skeleton, polyp fully extended in a burst of burnt-orange tentacles darkening to sunset amber at the tips, glowing in reef sunlight, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  margincrust: [
    'A small patch of velvety deep-teal encrusting alga on the underside of a reef overhang, narrow bright turquoise growing edge, faint concentric rings, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A spreading Margin Crust colony on shadowed reef overhang underside, rich deep teal velvet texture with vivid bright turquoise border marking current growth, concentric ring history visible, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Margin Crust covering a wide reef overhang underside, deep teal velvety sheet with brilliant turquoise annual growth border, two separate colonies meeting in perfect parallel lines at their edges, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  barnaclebough: [
    'A tiny gorgonian coral branch, a few centimetres tall, with the first chalky barnacle shells beginning to fuse into its skeleton, pale brown-gold axis, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Barnacle Bough gorgonian, branching structure with numerous white barnacle cones fused into the coral skeleton, warm brown and cream tones, polyps extending between barnacle shells, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Barnacle Bough in dramatic full display, an elaborate gorgonian tree densely armoured in generations of white barnacle cones calcified into the skeleton, ancient and architectural, warm amber-brown coral axis beneath chalk-white barnacle cones, deep blue ocean background with soft light rays filtering from above filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  mirrorveil: [
    'A tiny circular glass sponge disc, a few centimetres across, horizontal orientation, hammered-silver surface barely reflecting dim light from above, anchored to rock, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Mirror Veil glass sponge, flat circular disc of silver-white silica oriented horizontally, reflecting dim water light in slow distortions, attached to twilight-zone rock face, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Mirror Veil, a large perfect horizontal disc of hammered-silver glass sponge skeleton, collecting and distorting what little light filters from far above, rippling silver reflections moving across its surface, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  saltghost: [
    'A tiny transparent barrel-shaped tunicate drifting freely, barely visible as a slight water distortion, a faint warm glow at its centre from focused light above, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Salt Ghost tunicate, barrel-shaped transparent body drifting in twilight waters, nearly invisible save for gentle lens-distortion of the water around it, a soft focused warm point of light at its core, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Salt Ghost in full drift, a large perfectly transparent barrel body suspended in twilight waters, almost indistinguishable from water except for the luminous distortion of a lens and a single warm focused point of borrowed light at its heart, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  inkmantle: [
    'A small smooth patch of deep prussian blue-black bryozoan on twilight-zone rock wall, surface perfectly smooth, almost lacquer-like, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A spreading Ink Mantle colony, seamless sheet of deep prussian blue-black across rock wall, flawlessly smooth painted-looking surface, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A dramatic mature Ink Mantle covering an entire rock wall in seamless deep prussian blue-black, the surface appearing painted in the most refined blue imaginable, pure colour and utter silence, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  spinewrack: [
    'A small upright dark grey-green alga frond bristling with tiny rigid calcified spines ending in translucent beads, a handful of sediment particles caught on bead-tips, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Spine Wrack alga, several stiff branching fronds densely armoured in rows of calcified spines with translucent bead tips loaded with fine sediment particles, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Spine Wrack in full dramatic form, a dense stiff-branching alga almost entirely obscured by its armour of calcified spines, each spine ending in a glowing translucent bead heavy with sediment, an improbable fortress of a plant in the deep twilight, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  noctilacewing: [
    'A tiny sea pen with just-forming paired wing-like rachis, warm amber-gold bioluminescence barely beginning to pulse from the central axis, anchored in twilight sediment, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Noctilace Wing sea pen, broad paired wings of flattened rachis spreading wide, warm amber-gold bioluminescence pulsing outward from the central axis across the wing surface, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Noctilace Wing in full dramatic bloom, enormous paired wings of warm amber-gold bioluminescence radiating outward from the central axis in continuous flowing pulses, wings fully extended like a hovering abyssal bird, glowing gold against the twilight dark, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  forgottenlace: [
    'A tiny patch of intricate cream-and-ash lacework xenophyophore barely distinguishable from surrounding sediment, fractal lattice structure just visible on the twilight seafloor, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Forgotten Lace colony, spreading fractal lacework of cream and ash on the twilight seafloor, ornate lattice pattern more visible as it expands, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Forgotten Lace covering a wide expanse of twilight seafloor, vast fractal lacework of cream-and-ash that reveals extraordinary ornate lattice detail on close inspection, dark blue-purple ocean background with faint distant light filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  streamerveil: [
    'A small cluster of translucent pale filaments rising from abyssal sediment, barely a few centimetres tall, swaying very slightly in thermal current, faint glow, dark abyssal ocean background filling the entire image edge to edge, botanical illustration style, vertical composition',
    'Growing Streamer Veil filament curtains rising from abyssal sediment, translucent pale streamers half a metre tall swaying in slow thermal micro-currents, faint scattered thermal vent glow catching on the filaments, dark abyssal ocean background filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Streamer Veil in full dramatic display, tall translucent curtains of pale filaments several metres high swaying in slow thermal micro-currents, catching and scattering the faint thermal glow of nearby vents into something like fog at dusk, dark abyssal ocean background filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  ironcalyx: [
    'A small cluster of rust-red iron-stained calcite tubes on abyssal basalt, a few white feathery plumes just beginning to emerge from tube openings, dark abyssal ocean background filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Iron Calyx tube worm colony, dense rust-red tubes streaked with ochre and black iron oxide, white feathery feeding plumes extending from each tube tip, dramatic colour contrast, dark abyssal ocean background filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Iron Calyx colony in full bloom, a dramatic forest of deep rust-red and ochre-black iron-stained calcite tubes topped with luminous white feathery plumes, the contrast between dark rusted tubes and white plumes resembling a formal bouquet from the deep, dark abyssal ocean background filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  whaleorchid: [
    'A tiny pale lavender orchid-shaped bud emerging from the surface of an ancient whale vertebra on the abyssal floor, barely open, ivory edges, dark abyssal ocean background filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Whale Orchid, several orchid-shaped pale lavender and ivory blooms open on exposed whale bone, delicate petal forms, faint bioluminescent glow, dark abyssal ocean background filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Whale Orchid in full bloom, a breathtaking cluster of pale lavender and ivory orchid-shaped flowers covering an ancient whale vertebra, each bloom perfectly formed, glowing softly against the absolute dark, a garden that exists because something enormous died, dark abyssal ocean background filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  hadalpetrel: [
    'A tiny single pale upright frond just beginning to form its five-lobed apex, barely distinguishable from the hadal sediment around it, faint violet vein patterns beginning to glow, dark abyssal ocean background filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Hadal Petrel frond, single vertical structure splitting into five distinct lobes at the apex, each lobe tapering to a graceful curved point, faint intricate vein patterns glowing violet-white, dark abyssal ocean background filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'A mature Hadal Petrel in full dramatic display, a single tall upright frond splitting perfectly into five outstretched lobes like an open hand, ultraviolet vein patterns blazing with extraordinary intricate maps in glowing violet-white, the most solitary and extraordinary living thing in the deepest place on earth, dark abyssal ocean background filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  abyssalcrown: [
    'A tiny calcified column with just three or four translucent glass arms beginning to radiate outward, faint multi-colored bioluminescent fluid visible inside each arm, first hints of violet and teal glow, dark abyssal ocean background filling the entire image edge to edge, botanical illustration style, vertical composition',
    'A growing Abyssal Crown, calcified central column with eight radiating arms of living glass, each arm a hollow fused-silica tube, different colored bioluminescent fluids pulsing in sequence — violet teal gold — cycling slowly around the crown, dark abyssal ocean background filling the entire image edge to edge, painterly botanical illustration style, vertical composition',
    'The mature Abyssal Crown in its full legendary form, a perfect twelve-armed crown of living glass tubes rising from a calcified column, each arm containing a different bioluminescent fluid cycling through violet teal gold and a final colour beyond naming, the crown pulsing in slow sequence at the deepest point of the world, dark abyssal ocean background filling the entire image edge to edge, elegant botanical illustration style, vertical composition',
  ],
  lianhua: [
...
async function main(): Promise<void> {
  ...
  const USER_ADDED = [
    ...
    'seapansy', 'cresttunic', 'sunvarnish', 'needletuft', 'coppercup', 'margincrust', 'barnaclebough',
    'mirrorveil', 'saltghost', 'inkmantle', 'spinewrack', 'noctilacewing', 'forgottenlace',
    'streamerveil', 'ironcalyx', 'whaleorchid', 'hadalpetrel', 'abyssalcrown',
  ] as const;
