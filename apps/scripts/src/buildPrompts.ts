...
const OVERRIDES: Record<string, [string, string, string]> = {
  ...
  lianhua: [
    'A serene delicate anime child girl with big gentle eyes, thin petite body, long dark hair tied with a jade-green ribbon and tiny lotus bud hairpin, wearing a flowing layered jade-green and soft pink Wuxia-style silk robe with lotus leaf embroidery and wide billowing sleeves, the child kneeling gracefully beside a shallow ornate bronze water basin with a single sacred lotus seedling emerging from still water with one small round leaf floating, one small hand reaching toward the tiny pink lotus bud, hands partially hidden in long draping sleeves, refined Wuxia game art style, serene ethereal atmosphere, soft jade-green and pink watercolor ink wash splashes in the background with floating golden light particles and lotus petal sparkles, jade-green soft-pink and cream palette with gold sacred accents, white border edges with delicate ink splatter, no text no letters no writing no kanji no calligraphy, botanical illustration style, vertical composition',
    'A beautiful teenage anime girl in elaborate jade-green and white flowing silk Wuxia dress with intricate lotus flower and vine embroidery in gold thread, translucent layered silk ribbons cascading from shoulders and waist, ornate golden lotus crown headpiece with dangling jade beads and pearl chains in her hair, graceful meditative pose with one hand raised holding a glowing pink lotus bud, flowing dark magenta and jade-green silk ribbons swirling dynamically around her body like the wind, standing beside a young sacred lotus plant with several pink buds and unfurling leaves rising from an elegant celadon water vessel, soft golden divine light radiating from behind her, refined Wuxia game art style, ethereal sacred atmosphere, jade-green and soft-pink watercolor ink wash background with golden lotus mandala light patterns floating, jade-green white pink and gold palette, serene holy elegance, white border edges with ink splatter, no text no letters no writing no kanji no calligraphy, botanical illustration style, vertical composition',
    'A stunning slender adult anime woman with big expressive anime eyes and detailed anime face with soft blush, large breasts in luxurious flowing jade-green and white layered silk Wuxia robes with deep neckline and exposed elegant shoulders, intricate gold lotus and sacred cloud embroidery across the translucent fabric, long flowing black hair with anime-style highlights adorned with an elaborate golden lotus tiara with jade pendants and pearl-chain hair accessories cascading down, gold lotus arm bracelets and delicate body chain jewelry, seductive graceful Dunhuang apsara dancing pose with one arm raised high performing the elegant lanhuazhi orchid finger gesture with delicate curved pinky and ring finger and extended index finger, the other hand also in a graceful lanhuazhi pose near her waist, flowing jade-green magenta and white silk ribbons spiraling dynamically around her entire body like sacred wind, surrounded by fully bloomed magnificent sacred pink and white lotus flowers with ethereal golden divine light and floating lotus petals, a shallow sacred bronze lotus pond at her feet with lily pads and glowing water, Japanese anime illustration style with Chinese Wuxia aesthetic, cel-shaded anime coloring with soft gradients, refined Wuxia game art style, divine sacred atmosphere, jade-green and soft-pink watercolor ink wash background with golden lotus mandala halos and divine light rays floating, jade-green white pink and gold palette with sacred golden accents, divine sensual elegance, white border edges with ink splatter, no text no letters no writing no kanji no calligraphy, botanical illustration style, vertical composition',
  ],
};
...
async function main(): Promise<void> {
  ...
  const USER_ADDED = ['meihua', 'bianhua', 'lianhua'] as const;
